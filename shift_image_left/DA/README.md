...
Two images for hybrid combination that have the same height and width (part 7 of the script).
...
```bash
python run.py <path_to_wide_image> <path_to_tall_image> <path_to_hybrid_image1> <path_to_hybrid_image2>
```

Example:

```bash
python run.py wide.png tall.png hybrid1.png hybrid2.png
```
